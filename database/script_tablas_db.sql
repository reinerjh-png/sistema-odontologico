...
INSERT INTO `tenant_config` (`clinic_name`, `logo_url`, `color_primary`, `color_accent`, `color_sidebar`, `theme_mode`)
SELECT 'Clínica Dental Premium Uchuya', 'assets/logo.png', '#1B2B4B', '#4A90D9', '#1B2B4B', 'light'
